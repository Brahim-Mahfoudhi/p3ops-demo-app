pipeline {
    ...
    post {
        ...
        always {
            ...
            // Convert .trx to .xml (JUnit format)
            ...
            sh '/home/jenkins/.dotnet/tools/reportgenerator "-reports:p3ops-demo-app/tests/Domain.Tests/TestResults/test-results.xml" "-reports:/var/lib/jenkins/agent/workspace/dotnet_pipeline/coverage/coverage.cobertura.xml" "-targetdir:p3ops-demo-app/tests/Domain.Tests/TestResults/Report" -reporttypes:Html'
            
            // Publish the HTML report generated by ReportGenerator
