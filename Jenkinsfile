    ...
    stages {
        ...
        stage('Running Unit Tests') {
            steps {
                ...
                sh """
                    /home/jenkins/.dotnet/tools/reportgenerator "-reports:p3ops-demo-app/tests/Domain.Tests/TestResults/test-results.trx" "-targetdir:p3ops-demo-app/tests/Domain.Tests/TestResults/Report" -reporttypes:Html
                """
            }
        }
