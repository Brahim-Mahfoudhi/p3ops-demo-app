pipeline {
    ...
    post {
        ...
        always {
            ...
            sh '/home/jenkins/.dotnet/tools/reportgenerator "-reports:p3ops-demo-app/tests/Domain.Tests/TestResults/test-results.xml" "-targetdir:p3ops-demo-app/tests/Domain.Tests/TestResults/Report" -reporttypes:Html'    
