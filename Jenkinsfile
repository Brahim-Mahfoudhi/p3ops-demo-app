pipeline {
    ...
    environment {
        ...
        DOTNET_CONNECTION_STRING = 'Server=localhost,1433;Database=SportStore;User Id=sa;Password=sql-rise-1234;Trusted_Connection=False;MultipleActiveResultSets=True;'
